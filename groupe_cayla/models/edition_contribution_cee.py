...
class EditionContributionCEE(models.Model):
    _name = 'groupe_cayla.edition_contribution_cee'
    _description = 'Fiche contribution CEE'
    _inherit = ['mail.thread', 'mail.activity.mixin']
    _sql_constraints = [
        ('cee_id', 'unique (cee_id)', 'Ce dossier CEE a déjà une fiche contribution')
    ]
