...
class LigneDevis(models.Model):
    ...
    @api.depends('devis_id', 'sujet_devis_id', 'ligne_sujet_devis_id', 'prime_cee',
                 'devis_id.type_professionnel','devis_id.client_id','devis_id.client_id.cee_id', 'devis_id.client_id.cee_id.type_client_id.donne_droit_tarif_solidarite_energetique')
